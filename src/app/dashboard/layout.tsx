...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh grid md:grid-cols-[280px_1fr] bg-gradient-to-br from-purple-50 to-purple-100">
      <aside className="bg-white/80 backdrop-blur-md border-r border-purple-200/50 p-6 space-y-6">
      ...
      <div className="flex flex-col min-h-dvh">
        <header className="h-16 bg-white/80 backdrop-blur-md border-b border-purple-200/50 flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
